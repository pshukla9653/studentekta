...
<div id="page">
 ...
 <div class="page-content  header-clear-medium" id="otpbox" style="display:none;">
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
                  <strong>Success!</strong> <p class="font-20 font-900">Verification Code: 228226</p>
                  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                <div class="inputwidthotp">
                    
    
                        <input type="hidden" value="" name="mobilenumber" id="mobilenumber" maxlength="1">
                        <input class="otp mx-1 rounded-sm text-center font-20 font-900" id="digit-1" name="digit-1" data-next="digit-2" type="tel" value="" autofocus="autofocus" maxlength="1">
                        ...
                        <p class="text-center my-4 font-11">Didn't get your code? <a href="#" onclick="phoneSendAuth();">Resend Code</a></p>
                    
                        <button type="submit" onclick="otpverified();" class="btn btn-lg btn-l btn-info font-600 font-13 gradient-highlight mt-4 rounded-s border-0" >Next</button>
	...
	<div class="page-content header-clear-medium" id="regibox" style="display:none;">
		  ...
		  <div class="page-content header-clear-medium" id="loginbox" style="display:none;">
        
          <div class="inputwidth">
            <div class="card card-style p-4 text-center registration">
               <h2 class="pb-4">Login to <span>AAPKA SARTHI</span></h2>
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 pb-2">
                        <div class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                            ...
                            <input type="text" class="form-control validate-name font-900"  placeholder="Set User Name" >
                            <label for="form1" class="color-highlight font-500">User Name</label>
                            <i class="fa fa-times disabled invalid color-red-dark"></i>
                            <i class="fa fa-check disabled valid color-green-dark"></i>
                        </div>
                    </div>
                    ...
                    <div class="col-12 pb-2">
                        <div class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                            ...
                            <input type="text" class="form-control validate-name font-900"  placeholder="Set Password" >
                            <i class="far fa-eye-slash"></i>
                            <label for="form1" class="color-highlight font-500">Password</label>
                            <i class="fa fa-times disabled invalid color-red-dark"></i>
                            <i class="fa fa-check disabled valid color-green-dark"></i>
                        </div>
                    </div>
	...
	function otpverified(){
		...
		$.ajax({
                    ...
                    success: function (result) {
						console.log(result);
						if(result.id){
							window.location.href = "{{ route('colleges.edit',["+result.id+","+result.step_1+"]) }}";
						}
